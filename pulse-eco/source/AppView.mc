...
class AppView extends WatchUi.View {
    ...
    function _showProgressBar() as Void {
        ...
        _progressBar = new WatchUi.ProgressBar("Fetching...", null);
        WatchUi.pushView(_progressBar, null, WatchUi.SLIDE_DOWN);
    }
                ...
                if (viewModel.overallModel != null) {
                    ...
                    if (overallModel != null) {
                        ...
                        if (viewModel.cachedDate != null) {
                            ...
                            _lines.add(
                                new LineModel({
                                    :text => citySettingValueCapitaliezed.length() > 0
                                        ? citySettingValueCapitaliezed
                                        : "Updated",
                                    :suffixText => Lang.format(" $1$:$2$:$3$", [
                                        cachedDate.hour.format("%02d"),
                                        cachedDate.min.format("%02d"),
                                        cachedDate.sec.format("%02d"),
                                    ]),
