...
function renderText(params as { 
    ...
    var prefixTextColor = params.get(:prefixTextColor) != null ? params.get(:prefixTextColor) : Graphics.COLOR_WHITE;
    var textColor = params.get(:textColor) != null ? params.get(:textColor) : Graphics.COLOR_WHITE;
    var suffixTextColor = params.get(:suffixTextColor) ? params.get(:suffixTextColor) : Graphics.COLOR_WHITE;
